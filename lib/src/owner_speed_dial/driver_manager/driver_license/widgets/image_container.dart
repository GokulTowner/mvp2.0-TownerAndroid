...
class ImageContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final providerWatch = context.watch<DriverLicenseProvider>();
    return Consumer<DriverLicenseProvider>(
      builder: (context, provider, child) {
        return provider.dlImage == null && provider.dlPdf != null
            ? InkWell(
                onTap: () {
                  bottomSheet(
