...
class ImageShowContainerPanCard extends StatelessWidget {
  const ImageShowContainerPanCard({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<DriverGovIdProvider>(
      builder: (context, provider, child) {
        return provider.panCard == null && provider.panCardPdf != null
            ? InkWell(
                onTap: () {
                  bottomSheet(
                      context: context,
