...
class AboutUsService {
  final Map<String, dynamic> aboutUsData = {
    "title": "About TOWNER",
    "description":
        "At TOWNER, we are dedicated to providing the best taxi booking experience for our customers. Our mission is to make taxi booking convenient, reliable, and hassle-free.",
    "vision":
