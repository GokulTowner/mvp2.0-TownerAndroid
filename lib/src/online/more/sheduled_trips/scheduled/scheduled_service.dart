...
class ScheduledService {
  ...
  Future<List<ScheduledModel>?> fetchScheduledTripDetails() async {
    try {
      ...
      if (statuscode == 200) {
        ...
        List<ScheduledModel> scheduleTripData = scheduledRideDatas
            .whereType<Map<String, dynamic>>()
            .map((scheduledtrip) => ScheduledModel.fromJson(scheduledtrip))
            .toList();
