...
class SheduledTab extends StatelessWidget {
  const SheduledTab({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Consumer<SheduledProvider>(
        builder: (BuildContext context, provider, Widget? child) {
          print('past trips length :- ${provider.trips?.length}');
  ...
  rideWidget(BuildContext context, MyTripsModal trips) {
    return Column(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              buildText(AppLocalizations.of(context)!.scheduled, trips.date.toString()),
              buildText(AppLocalizations.of(context)!.tripType, trips.triptype.toString()),
